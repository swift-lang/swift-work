...
foreach i in [0:362] {
  ...
  string cmd_1 = sprintf(cmd_noop, "fastqSplit", root_in_files[0], 0.9, 500, of, 1985703, dep_1);
  printf(cmd_1);
...
foreach i in [0:12316] {
  ...
  string cmd_2 = sprintf(cmd_noop, "filterContams", filterContams_in, 0.9, 500, of, 1985703, dep_2);
  string co_2 = python_persist(cmd_2);
...
foreach i in [0:12316] {
  ...
  string cmd_3 = sprintf(cmd_noop, "sol2sanger", sol2sanger_in, 0.9, 500, of, 1985703, dep_3);
  string co_3 = python_persist(cmd_3);
...
foreach i in [0:12316] {
  ...
  string cmd_4 = sprintf(cmd_noop, "fast2bfq", fast2bfq_in, 0.9, 500, of, 1985703, dep_4);
  string co_4 = python_persist(cmd_4);
...
foreach i in [0:12316] {
  ...
  string cmd_5 = sprintf(cmd_noop, "map", map_in, 0.9, 500, of, 1985703, dep_5);
...
foreach i in [0:362] {
  ...
  string cmd_6 = sprintf(cmd_noop, "mapMerge", mapMerge_in, 0.9, 500, of, 1985703, dep_6);
